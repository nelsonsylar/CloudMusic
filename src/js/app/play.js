...
export default (function play(){
    let view={
        ...
        <div class="playbutton">
            <div class="play"><img src="../src/img/播放.png" alt=""></div>
            <div class="pause"><img src="../src/img/暂停.png" alt=""></div>
        </div>
        </div> 
    </div>
    ...
    let controller={
        ...
        bindEvents(){
            $(this.view.el).on('click','.playbutton',(e)=>{
                if(this.model.data.playStatus==='playing'){
                    this.model.data.playStatus='pausing'
                    $(e.currentTarget).removeClass('active')
                    $(this.view.el).find('.discWrapper').removeClass('active')
                    this.pause()
                }else if(this.model.data.playStatus==='pausing'){
                    this.model.data.playStatus='playing'
                    this.play()
                    $(e.currentTarget).addClass('active')
                    $(this.view.el).find('.discWrapper').addClass('active')
                }  
            })
                ...
                if(audio){
                    ...
                    audio.addEventListener('ended', () =>{  
                        this.model.data.playStatus='pausing'
                        $(this.view.el).find('.playbutton').removeClass('active')
                        $(this.view.el).find('.discWrapper').removeClass('active')
                    }, false);
                }
                audio.ontimeupdate=()=>{
